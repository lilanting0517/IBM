...
], function(parser, declare, lang, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, on, at, Stateful, NumberTextBox, CheckBox, CustomSelector, user) {

    return declare("CloseOutCallWidget", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
